...
def path_to_profile(config, profile_name: str) -> str:
    ...
    """
    if profile_name:
        return os.path.join(config.config_path, profile_name + ".json")
...
def path_to_profile_lock(config, profile_name: str) -> str:
    ...
    """
    return os.path.join(config.config_path, profile_name + ".lock")
...
def tasks(config, profile_name: str) -> List[Task]:
    """
...
def lock(config, profile_name: str) -> bool:
    """
...
def unlock(config, profile_name: str) -> None:
    """
